...
| Agent-C + KSP-BF | 0.4916±0.2690 | -0.175 | 7.7±1.8 | 3.45 | 0.313 | 623.4 | 55.0% | 2 | 100.0% | 0.0% |
...
- Success: 3596 (45.0%)
- Total BF time: 30.3s
- Δblocking (Agent-C → KSP-BF): -0.0144

## Failure Reasons

- **Agent-C + PPO-R**: no_suitable_block=3818 (100.0%)
...
- **Agent-C + KSP-BF**: no_suitable_block=3932 (100.0%), server_overload=1 (0.0%)

## Split Distribution

- **Agent-C + PPO-R**: split0=53.9%, split4=39.4%, split3=4.8%, split2=1.5%, split1=0.5%
...
- **Agent-C + KSP-BF**: split0=55.2%, split4=39.0%, split3=4.3%, split2=1.2%, split1=0.3%

## Server Distribution

- **Agent-C + PPO-R**: s0=70.2%, s3=13.4%, s1=10.3%, s2=6.0%
...
- **Agent-C + KSP-BF**: s0=71.0%, s3=12.6%, s1=10.0%, s2=6.4%

## Modulation Distribution

- **Agent-C + PPO-R**: BPSK=42.2%, 16QAM=22.6%, QPSK=20.6%, 8QAM=14.6%
...
- **Agent-C + KSP-BF**: BPSK=64.4%, QPSK=21.1%, 8QAM=11.4%, 16QAM=3.2%
