...
**Agent-C:** `sa_hmarl/checkpoints/agent_c_gated_tmf_v2_indppo_s42_s20_r80_best.pt`  
**Agent-R:** `sa_hmarl/checkpoints/agent_r_mixed.pt`  

**Seeds:** 42,123,456,789,101112  **Eps/seed:** 20  **Requests/ep:** 80

**Total time:** 547s (9.1 min)

## Results

| Method | Blocking | Reward | Delay(ms) | AvgFS | Waste | PathKm | noC% | avgRacts | NSB% | SvrOv% |
|--------|----------|--------|-----------|-------|-------|--------|------|----------|------|--------|
| Agent-C + PPO-R | 0.4240±0.2670 | -0.120 | 11.6±1.9 | 2.57 | 0.353 | 676.4 | 48.8% | 3 | 96.9% | 3.1% |
...
| Agent-C + KSP-BF | 0.4281±0.2685 | -0.116 | 11.7±2.0 | 2.62 | 0.331 | 676.8 | 49.3% | 3 | 94.1% | 5.9% |
...
- Success: 4063 (50.8%)
- Total BF time: 38.6s
- Δblocking (Agent-C → KSP-BF): -0.0041

## Failure Reasons

- **Agent-C + PPO-R**: no_suitable_block=3286 (96.9%), server_overload=106 (3.1%)
...
- **Agent-C + KSP-BF**: no_suitable_block=3222 (94.1%), server_overload=203 (5.9%)

## Split Distribution

- **Agent-C + PPO-R**: split0=76.1%, split4=14.3%, split1=3.5%, split3=3.1%, split2=2.9%
...
- **Agent-C + KSP-BF**: split0=78.1%, split4=13.4%, split1=2.9%, split2=2.9%, split3=2.7%

## Server Distribution

- **Agent-C + PPO-R**: s0=62.8%, s1=14.4%, s3=12.1%, s2=10.6%
...
- **Agent-C + KSP-BF**: s0=64.3%, s1=14.0%, s3=11.6%, s2=10.1%

## Modulation Distribution

- **Agent-C + PPO-R**: BPSK=56.4%, QPSK=19.8%, 8QAM=13.1%, 16QAM=10.7%
...
- **Agent-C + KSP-BF**: BPSK=69.9%, QPSK=16.3%, 8QAM=10.8%, 16QAM=3.0%
