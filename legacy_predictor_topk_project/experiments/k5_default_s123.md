...
| Agent-C + KSP-BF | 0.3848±0.2852 | -0.078 | 11.6±2.6 | 2.32 | 0.359 | 679.8 | 44.4% | 5 | 90.3% | 9.7% |
...
- Success: 4462 (55.8%)
- Total BF time: 93.8s
- Δblocking (Agent-C → KSP-BF): -0.0105

## Failure Reasons

- **Agent-C + PPO-R**: no_suitable_block=2698 (90.1%), server_overload=296 (9.9%)
...
- **Agent-C + KSP-BF**: no_suitable_block=2779 (90.3%), server_overload=299 (9.7%)

## Split Distribution

- **Agent-C + PPO-R**: split0=94.5%, split1=2.2%, split2=1.5%, split3=1.3%, split4=0.6%
...
- **Agent-C + KSP-BF**: split0=94.8%, split1=2.1%, split2=1.3%, split3=1.2%, split4=0.5%

## Server Distribution

- **Agent-C + PPO-R**: s0=62.2%, s3=23.6%, s1=7.9%, s2=6.3%
...
- **Agent-C + KSP-BF**: s0=63.3%, s3=23.1%, s1=7.8%, s2=5.8%

## Modulation Distribution

- **Agent-C + PPO-R**: BPSK=75.0%, QPSK=10.6%, 16QAM=7.6%, 8QAM=6.8%
...
- **Agent-C + KSP-BF**: BPSK=88.3%, QPSK=9.9%, 8QAM=1.7%, 16QAM=0.1%
