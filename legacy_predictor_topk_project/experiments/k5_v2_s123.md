...
**Agent-C:** `sa_hmarl/checkpoints/agent_c_gated_tmf_v2_indppo_s123_s20_r80_best.pt`  
**Agent-R:** `sa_hmarl/checkpoints/agent_r_mixed.pt`  

**Seeds:** 42,123,456,789,101112  **Eps/seed:** 20  **Requests/ep:** 80

**Total time:** 534s (8.9 min)

## Results

| Method | Blocking | Reward | Delay(ms) | AvgFS | Waste | PathKm | noC% | avgRacts | NSB% | SvrOv% |
|--------|----------|--------|-----------|-------|-------|--------|------|----------|------|--------|
| Agent-C + PPO-R | 0.4636±0.2580 | -0.160 | 8.5±2.0 | 2.91 | 0.355 | 591.6 | 53.2% | 2 | 99.4% | 0.6% |
...
| Agent-C + KSP-BF | 0.4809±0.2587 | -0.171 | 8.7±2.2 | 3.19 | 0.325 | 606.1 | 54.7% | 2 | 99.3% | 0.7% |
...
- Success: 3624 (45.3%)
- Total BF time: 31.2s
- Δblocking (Agent-C → KSP-BF): -0.0173

## Failure Reasons

- **Agent-C + PPO-R**: no_suitable_block=3687 (99.4%), server_overload=22 (0.6%)
...
- **Agent-C + KSP-BF**: no_suitable_block=3821 (99.3%), server_overload=26 (0.7%)

## Split Distribution

- **Agent-C + PPO-R**: split0=56.5%, split4=20.2%, split3=8.9%, split2=8.4%, split1=6.0%
...
- **Agent-C + KSP-BF**: split0=58.1%, split4=19.5%, split2=8.5%, split3=8.2%, split1=5.6%

## Server Distribution

- **Agent-C + PPO-R**: s0=69.2%, s3=15.0%, s1=9.4%, s2=6.5%
...
- **Agent-C + KSP-BF**: s0=70.1%, s3=14.2%, s1=9.0%, s2=6.7%

## Modulation Distribution

- **Agent-C + PPO-R**: BPSK=57.1%, QPSK=19.9%, 16QAM=14.8%, 8QAM=8.2%
...
- **Agent-C + KSP-BF**: BPSK=78.0%, QPSK=16.5%, 8QAM=5.0%, 16QAM=0.5%
