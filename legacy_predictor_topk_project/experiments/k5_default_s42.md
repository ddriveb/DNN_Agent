...
| Agent-C + KSP-BF | 0.4185±0.2822 | -0.092 | 10.7±2.2 | 2.70 | 0.337 | 695.6 | 48.2% | 2 | 98.1% | 1.9% |
...
- Success: 4145 (51.8%)
- Total BF time: 59.2s
- Δblocking (Agent-C → KSP-BF): -0.0042

## Failure Reasons

- **Agent-C + PPO-R**: no_suitable_block=3264 (98.5%), server_overload=50 (1.5%)
...
- **Agent-C + KSP-BF**: no_suitable_block=3285 (98.1%), server_overload=63 (1.9%)

## Split Distribution

- **Agent-C + PPO-R**: split0=55.1%, split1=12.9%, split4=12.2%, split2=11.3%, split3=8.5%
...
- **Agent-C + KSP-BF**: split0=55.8%, split1=13.4%, split4=11.8%, split2=11.0%, split3=8.1%

## Server Distribution

- **Agent-C + PPO-R**: s0=62.9%, s1=14.4%, s2=12.0%, s3=10.7%
...
- **Agent-C + KSP-BF**: s0=62.9%, s1=13.9%, s2=12.0%, s3=11.1%

## Modulation Distribution

- **Agent-C + PPO-R**: BPSK=54.2%, QPSK=22.2%, 8QAM=11.9%, 16QAM=11.7%
...
- **Agent-C + KSP-BF**: BPSK=68.2%, QPSK=21.6%, 8QAM=9.1%, 16QAM=1.1%
