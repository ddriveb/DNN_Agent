...
**Agent-C:** `sa_hmarl/checkpoints/agent_c_candidate_mean_field_count_only_s42_s20_r80_best.pt`  
**Agent-R:** `sa_hmarl/checkpoints/agent_r_mixed.pt`  

**Seeds:** 42,123,456,789,101112  **Eps/seed:** 20  **Requests/ep:** 80

**Total time:** 1513s (25.2 min)

## Results

| Method | Blocking | Reward | Delay(ms) | AvgFS | Waste | PathKm | noC% | avgRacts | NSB% | SvrOv% |
|--------|----------|--------|-----------|-------|-------|--------|------|----------|------|--------|
| Agent-C + PPO-R | 0.4496±0.2644 | -0.118 | 9.3±1.1 | 2.80 | 0.330 | 660.1 | 51.8% | 2 | 100.0% | 0.0% |
...
| Agent-C + KSP-BF | 0.4624±0.2614 | -0.130 | 9.3±1.1 | 2.93 | 0.317 | 663.7 | 52.8% | 2 | 99.9% | 0.1% |
...
- Success: 3776 (47.2%)
- Total BF time: 49.2s
- Δblocking (Agent-C → KSP-BF): -0.0128

## Failure Reasons

- **Agent-C + PPO-R**: no_suitable_block=3596 (100.0%), server_overload=1 (0.0%)
...
- **Agent-C + KSP-BF**: no_suitable_block=3697 (99.9%), server_overload=2 (0.1%)

## Split Distribution

- **Agent-C + PPO-R**: split0=58.2%, split4=30.7%, split3=3.8%, split1=3.7%, split2=3.6%
...
- **Agent-C + KSP-BF**: split0=59.5%, split4=29.6%, split3=3.7%, split1=3.6%, split2=3.6%

## Server Distribution

- **Agent-C + PPO-R**: s0=65.1%, s1=13.4%, s2=10.9%, s3=10.6%
...
- **Agent-C + KSP-BF**: s0=66.0%, s1=13.1%, s2=10.5%, s3=10.4%

## Modulation Distribution

- **Agent-C + PPO-R**: BPSK=46.2%, QPSK=22.6%, 8QAM=17.0%, 16QAM=14.2%
...
- **Agent-C + KSP-BF**: BPSK=59.9%, QPSK=21.0%, 8QAM=14.6%, 16QAM=4.5%
