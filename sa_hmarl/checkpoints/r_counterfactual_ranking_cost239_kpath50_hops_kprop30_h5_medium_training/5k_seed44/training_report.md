...
- Horizon: 5
- Checkpoint: `/mnt/d/project/DNN_Agent/sa_hmarl/checkpoints/r_counterfactual_ranking_cost239_kpath50_hops_kprop30_h5_medium_training/5k_seed44/ranking_model.pt`
...
| Test top-1 | 6.84% |
| Test top-3 | 15.50% |
| Test tie-aware top-1 | 44.29% |
| Test NDCG@3 | 0.626 |
| Test Spearman mean | -0.010 |
| Test Kendall tau-b | -0.008 |
| Test pairwise accuracy | 0.518 |
| Test relative regret reduction | -0.1818 |
| Test model regret | 0.0724 |
| Test PPO regret | 0.1050 |
| Test PPO agreement | 8.33% |
| Test score std | 0.6714 |
| Test KL | 0.0315 |