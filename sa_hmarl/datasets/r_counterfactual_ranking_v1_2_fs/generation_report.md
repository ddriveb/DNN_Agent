...
- Candidate mode: `v1`
- Horizon H: 5
- Return: `-3.0*cur_blocked - 4.0*future_blocked - 3.0*future_nsb - 0.03*delay_mean - 0.05*avg_fs - 0.0*norm(path_km) - 0.05*norm(required_fs)`

| Split | Groups | Skipped | Avg cand | P50 | P90 | Nonzero range | PPO top-1 | Oracle headroom (pp) | Future blocked var |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| train | 1433 | 0 (0.0%) | 8.14 | 7 | 15 | 68.32% | 32.24% | 0.0070 | 0.0107 |
| val | 217 | 0 (0.0%) | 8.79 | 8 | 15 | 64.98% | 38.71% | 0.0175 | 0.0185 |
| test | 143 | 0 (0.0%) | 6.97 | 4 | 15 | 48.25% | 40.56% | 0.0098 | 0.0180 |
