...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Strict v1.3 | 43.9067% | 0.0000% | 0.0000% | 43.9067% | 0.0000% | 22.73 | 2.35 | 1756.51 | 8.85 |
| KSP-FF K=50 hops | 43.9067% | 0.0000% | 0.0000% | 43.9067% | 0.0000% | 18.27 | 2.18 | 1310.00 | 3.12 |

**Blocking difference**: Strict v1.3 - KSP-FF K=50 hops = **0.00 pp**

## Mechanism Summary

Across the evaluated seeds under fixed-C / fixed-OD, Strict v1.3 achieves a blocking rate of 43.9067% while KSP-FF K=50 hops achieves 43.9067%, a difference of 0.00 percentage points.

Admitted-request path preferences differ: Strict v1.3 averages 3.23 hops / 1756.51 km, while KSP-FF K=50 hops averages 1.00 hops / 1310.00 km.

Strict v1.3 uses an average of 2.35 FS per admitted request, whereas KSP-FF K=50 hops uses 2.18 FS.

KSP-FF K=50 hops action is present in Strict v1.3's PPO-R Top-30 candidate pool in 20.71% of evaluated requests.
...
|---|---|---|
| Avg path idx | 11.77 | 0.00 |
| Avg required FS | 2.35 | 2.18 |
| Avg block start | 55.73 | 30.12 |
| Avg block waste | 0.9820 | 0.2227 |
| Avg hops | 3.23 | 1.00 |
| Avg path km | 1756.51 | 1310.00 |
